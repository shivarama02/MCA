...
create table regions(region_id varchar(10) primary key,
region_name varchar(50));

create table countries(country_id varchar(10) primary key,
country_name varchar(50),
region_id varchar(10),
foreign key (region_id) references regions(region_id));

create table locations(location_id varchar(10) primary key,
...
create table departments(department_id varchar(10) primary key,
...
create table dependents(dependent_id varchar(10),
first_name varchar(50),
last_name varchar(50),
...
('16','SalesRepresentative',6000.00,12000.00),
...
select first_name,last_name from employees where hire_date >= "1995-1-1" and hire_date <= "1997-12-31";
...
insert into employees (employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id,comission) values ('207','Paul','Newton','paulnewton@sqltutorial.org','515.123.4569','1998-12-30','5','5500.00','100','8',null);
